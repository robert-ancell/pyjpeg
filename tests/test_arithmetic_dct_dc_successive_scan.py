...
def test_arithmetic_dct_dc_successive_scan():
    data_units = []
    for _ in range(4):
    ...
    scan = pyjpeg.ArithmeticDCTDCSuccessiveScan(data_units, point_transform=3)
    scan.write(writer)
    ...
    scan2 = pyjpeg.ArithmeticDCTDCSuccessiveScan.read(
